...
#     """
#      decodator for extension functions that wants to be notified of
#      group/subgroups hierarchy changes
#      """
...
def on_contact_field_changed(field_id):
    """
    decorator for extension functions that wants to be notified of a specific
    field changes"""
    def wrapped(func):

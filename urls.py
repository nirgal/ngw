...
urlpatterns = patterns('',
    ...
    (r'^contacts/search$', 'ngw.gp.newsearch.contactsearch'),
    (r'^contacts/search/fields/(?P<kind>\w+)$', 'ngw.gp.newsearch.contactsearch_get_fields'),
    (r'^contacts/search/filters/(?P<field>\w+)$', 'ngw.gp.newsearch.contactsearch_get_filters'),
    (r'^contacts/search/params/(?P<field>\w+)/(?P<filtername>\w+)$', 'ngw.gp.newsearch.contactsearch_get_params'),
    (r'^contacts/search/filter_to_html$', 'ngw.gp.newsearch.contactsearch_filter_to_html'),

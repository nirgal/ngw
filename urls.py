...
urlpatterns = patterns('',
    ...
    url(r'^contacts/ajaxsearch/custom/user$', 'ngw.core.contactsearch.ajax_get_customfilters'),
    url(r'^contacts/ajaxsearch/(?P<column_type>\w+)/(?P<column_id>\w+)$', 'ngw.core.contactsearch.ajax_get_filters'),
    url(r'^contacts/ajaxsearch/custom/user/(?P<filter_id>[^/]+)$', 'ngw.core.contactsearch.ajax_get_customfilters_params'),

...
urlpatterns = patterns('',
    ...
    (r'^contactgroups/(?P<gid>\d+)/remove/(?P<cid>\d+)$', 'ngw.core.views.contactingroup_delete'),
    (r'^contactgroups/(?P<gid>\d+)/members/(?P<cid>\d+)/$', 'ngw.core.views.contactingroup_edit'),
    (r'^contactgroups/(?P<gid>\d+)/members/(?P<cid>\d+)/delete$', 'ngw.core.views.contactingroup_delete'),

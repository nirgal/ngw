...
urlpatterns = patterns(
    ...
    url(r'^contacts/ajaxsearch/custom/user$',
        ContactSearchCustomFiltersView.as_view()),
    url(r'^contacts/ajaxsearch/(?P<column_type>\w+)/(?P<column_id>\w+)$',
        ContactSearchColumnFiltersView.as_view()),
    url(r'^contacts/ajaxsearch/custom/user/(?P<filter_id>[^/]+)$',
        ContactSearchCustomFilterParamsView.as_view()),
    url(r'^contacts/ajaxsearch/(?P<column_type>\w+)/(?P<column_id>\w+)'
        r'/(?P<filter_id>[^/]+)$',

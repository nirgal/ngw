...
urlpatterns = patterns(
    ...
    url(r'^contacts/ajaxsearch/saved/user$',
        ContactSearchSavedFiltersView.as_view(),
        {'saved_type': 'user'}),
    url(r'^contacts/ajaxsearch/saved/global$',
        ContactSearchSavedFiltersView.as_view(),
        {'saved_type': 'global'}),
    url(r'^contacts/ajaxsearch/(?P<column_type>\w+)/(?P<column_id>\w+)$',
        ContactSearchColumnFiltersView.as_view()),
    url(r'^contacts/ajaxsearch/saved/user/(?P<filter_id>[^/]+)$',
        ContactSearchSavedFilterParamsView.as_view(),
        {'saved_type': 'user'}),
    url(r'^contacts/ajaxsearch/saved/global/(?P<filter_id>[^/]+)$',
        ContactSearchSavedFilterParamsView.as_view(),
        {'saved_type': 'global'}),
    url(r'^contacts/ajaxsearch/(?P<column_type>\w+)/(?P<column_id>\w+)'
        r'/(?P<filter_id>[^/]+)$',
